        ...
        <div id="content">
          ...
          <div class="row d-flex justify-content-center">
              ...
              <div class="col-lg-11 mb-4">
                ...
                // Query untuk mengambil data dari tabel 'iku'
                $query = "SELECT sasaran, no_iku, indikator, target_kinerja FROM iku";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    $xValues[] = $row['no_iku'];
                    $yValues[] = $row['target_kinerja'];
                }
            ?>

            <script>
                // Mengonversi data PHP menjadi JavaScript
                var xValues = <?php echo json_encode($xValues); ?>;
                var yValues = <?php echo json_encode($yValues); ?>;
                var barColors = ["#ff6961", "#ffb480", "#f8f38d", "#42d6a4", "#95dcdc", "#59adf6", "#9d94ff", "#c780e8"];
                    ...
                    options: {
                        ...
                        scales: {
                            yAxes: [{
                                ticks: {
                                    beginAtZero: true,
                                    suggestedMax: 200 // Atur nilai maksimum sumbu Y
                                }
                            }]
                        }
                    }
